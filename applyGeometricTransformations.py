...
class applyGeometricTransformations(object):
    ...
    Args:
            startXs (ndarray): Array of starting X-coordinates of points.
            startYs (ndarray): Array of starting Y-coordinates of points.
            newXs (ndarray): Array of new X-coordinates of points.
            newYs (ndarray): Array of new Y-coordinates of points.
            bbox (ndarray): Array of bounding boxes.

    Returns:
            ndarray: Array of updated X-coordinates of points.
            ndarray: Array of updated Y-coordinates of points.
            ndarray: Array of updated bounding boxes.
    ...
    def transform(self):
        ...
        for idx in range(no_objects):
            ...
            matrix = tform.params
            threshold = 1
            projected_points = matrix.dot(
                np.vstack((src.T.astype(float), np.ones([1, np.shape(src)[0]])))
            )
